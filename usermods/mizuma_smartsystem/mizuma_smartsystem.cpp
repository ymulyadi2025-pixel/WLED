...
// =========================================================================
// BLOK 1: KOMPONEN BOTTOM NAVIGATION (CSS & HTML)
// =========================================================================
...
<div class="bottomnav">
  <a href="/app" class="__ACTIVE_HOME__">
    <span class="bn-icon">&#127968;</span>Beranda
  </a>
  <a href="/led" class="__ACTIVE_LED__">
    <span class="bn-icon">&#128161;</span>LED
  </a>
  <a href="#" class="disabled">
    <span class="bn-icon">&#128267;</span>Aki
  </a>
  <a href="#" class="disabled">
    <span class="bn-icon">&#128736;</span>Servis
  </a>
  <a href="#" class="disabled">
    <span class="bn-icon">&#128274;</span>Anti-Theft
  </a>
  <a href="#" class="disabled">
    <span class="bn-icon">&#128205;</span>GPS
  </a>
  <a href="/settings/um" class="">
    <span class="bn-icon">&#127961;</span>Motor
  </a>
  <a href="/settings/wifi" class="">
    <span class="bn-icon">&#128246;</span>Jaringan
  </a>
</div>
)rawliteral";

// =========================================================================
// BLOK 2: DASHBOARD UTAMA / SHELL UI (/app)
// =========================================================================
...
<body>
  ...
  <div class="container">
    ...
    <div class="grid">
      <a class="card" href="/led">
        <div class="icon">&#128161;</div>
        <div class="label">LED Alis</div>
      </a>
      <a class="card" href="#">
        <div class="icon">&#128267;</div>
        <div class="label">Kondisi Aki</div>
      </a>
      <a class="card" href="#">
        <div class="icon">&#128736;</div>
        <div class="label">Reminder Servis</div>
      </a>
      <a class="card" href="#">
        <div class="icon">&#128274;</div>
        <div class="label">Anti-Theft</div>
      </a>
      <a class="card" href="#">
        <div class="icon">&#128205;</div>
        <div class="label">Lokasi GPS</div>
      </a>
      <a class="card" href="/settings/um">
        <div class="icon">&#127961;</div>
        <div class="label">Data Motor</div>
      </a>
      <a class="card" href="/settings/wifi">
        <div class="icon">&#128246;</div>
        <div class="label">Jaringan</div>
      </a>
    </div>
  </div>
...
// =========================================================================
// BLOK 3: UI LED ALIS WITH FREEZE PANE (/led) - FASE 5
// =========================================================================
...
<body>
  ...
  <div class="freeze">
    <div class="backbar">
      <a href="/app">&larr; Kembali ke Menu</a>
    </div>
  ...
  <div class="body-layout">
    <div class="subnav" id="subnav">
      <button data-sub="warna" class="active">
        <span class="icon">&#127912;</span>Pola Warna
      </button>
      <button data-sub="efek">
        <span class="icon">&#10024;</span>Efek
      </button>
      <button data-sub="simpan">
...
// =========================================================================
// BLOK 4: STRUKTUR DATA & VARIABEL USERMOD (C++)
// =========================================================================
...
// =========================================================================
// BLOK 5: SISTEM PENYIMPANAN KONFIGURASI LITTLEFS (addToConfig & readFromConfig)
// =========================================================================
  public:
    // Menyimpan Konfigurasi ke LittleFS WLED
    ...
    // Membaca Konfigurasi dari LittleFS WLED
...
// =========================================================================
// BLOK 6: HELPER RENDER, WEB SERVER ROUTING, LOOP & REGISTRASI WLED
// =========================================================================
  private:
    // Helper untuk menyuntikkan Bottom Nav CSS & HTML
...
// Registrasi Usermod Native ke Ekosistem WLED
